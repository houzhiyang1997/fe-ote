...
class Config:
    def __init__(self, args, num_outputs):
        ...
        self.save_path = '../models/model_parameters/TBXC_{}_parameter.bin'.format(args.interaction_mode)
...
class TBXC(nn.Module):
    def __init__(self, args, config, device):
        ...
        if args.interaction_mode == 'mlp':
            self.gelu = nn.GELU()
            self.weibo_linear = nn.Linear(config.weibo_max_seq_length,
